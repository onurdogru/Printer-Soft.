...
namespace SEGER68E
{
    public class ProcessForm
    {
        ...
        public void ProcessStart(int stepState, int stepStateMax)
        {
            ...
            {
                case 1:
                    this.MainFrm.lblStep1.Text = "1     1. KARTIN PROGRAMLANMASI";
                    break;

                case 2:
                    this.MainFrm.lblStep2.Text = "2     2. KARTIN PROGRAMLANMASI";
                    break;

                case 3:
                    this.MainFrm.lblStep3.Text = "3     1. KARTIN GÜÇ ÖLÇÜMLERİ";
                    break;

                case 4:
                    this.MainFrm.lblStep4.Text = "4     1. KARTIN FREKANS ÖLÇÜMLERİ";
                    break;

                case 5:
                    this.MainFrm.lblStep5.Text = "5     1. KARTIN FREKANS TP12 ÖLÇÜMÜ";
                    break;

                case 6:
                    this.MainFrm.lblStep6.Text = "6     1. KARTIN FREKANS TP13 ÖLÇÜMÜ";
                    break;

                case 7:
                    this.MainFrm.lblStep7.Text = "7     2. KARTIN GÜÇ ÖLÇÜMLERİ";
                    break;

                case 8:
                    this.MainFrm.lblStep8.Text = "8     2. KARTIN FREKANS ÖLÇÜMLERİ";
                    break;

                case 9:
                    this.MainFrm.lblStep9.Text = "9     2. KARTIN FREKANS TP12 ÖLÇÜMÜ";
                    break;

                case 10:
                    this.MainFrm.lblStep10.Text = "10    2. KARTIN FREKANS TP13 ÖLÇÜMÜ";
                    break;
        ...
        public void ProcessSuccess(int stepState)   //YENİ
        {
            switch (stepState)
            {
                case 1:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep1.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[1]);
                    break;
                ...
                case 2:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep2.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[2]);
                    break;
                ...
                case 3:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep3.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[1]);
                    break;
                ...
                case 4:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep4.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[1]);
                    break;
                ...
                case 5:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep5.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[1]);
                    break;
                ...
                case 6:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep6.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[1]);
                    break;
                ...
                case 7:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep7.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[2]);
                    break;
                ...
                case 8:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep8.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[2]);
                    break;
                ...
                case 9:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep9.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[2]);
                    break;
                ...
                case 10:
                    ...
                    this.MainFrm.fonksiyonTestInsert(Convert.ToString(stepState), this.MainFrm.lblStep10.Text, "PASSED", "0", "0", "0", "1", this.MainFrm.urun_id[2]);
                    break;
        ...
        public void ProcessFailed(int stepState)  //YENİ
        {
            switch (stepState)
            {
                case 1:
